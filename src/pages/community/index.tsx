...
type EventItem = {
  ...
  tagVariant: "blue" | "amber" | "green" | "purple";
  title: string;
  meta: string;
      ...
      <main className={styles.page}>
        <section className={styles.hero}>
          <div className={styles.container}>
            <h1>Community</h1>
            <p>
              OpenChoreo is built with and for platform engineers. Get involved,
              share your work, and help shape what comes next.
            </p>
          </div>
        </section>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.eventGrid}>
              {filteredEvents.map((event) => (
                <article
                  className={[styles.eventCard].join(" ")}
                  key={event.title}
                >
                  ...
                  <div className={styles.eventBody}>
                    ...
                    <div className={styles.eventActions}>
                      ...
                      {event.secondaryAction && (
                        <button
                          className={`button button--secondary button--sm ${styles.eventActionButton}`}
                          type="button"
                        >
                          {event.secondaryAction}
                        </button>
