            ...
            <div className={styles.heroInner}>
              <div className={styles.heroCopy}>
                ...
                <p className={styles.heroLead}>
                  Backstage gives developers one tab instead of 100. OpenChoreo
                  gives platform engineers one platform instead of 100 tools.
                  Together, they turn an informational portal into an actionable
                  developer platform.
                </p>
          ...
          <div className="container">
            <div className={styles.ctaInner}>
              ...
              <div className={styles.ctaActions}>
                ...
                <Button to={useBaseUrl("/docs/")}>Read the Docs</Button>
              </div>
            </div>
          </div>
        </section>
