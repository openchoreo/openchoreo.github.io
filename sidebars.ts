...
const sidebars: SidebarsConfig = {
  docsSidebar: [
      ...
      items: [
        {
          ...
          items: [
            {
              type: "doc",
              id: "user-guide/cli-installation",
              label: "Installation",
            },
          ],
        },
        ...
        },
        {
          type: "category",
          label: "Workload",
          items: ["user-guide/workload/overview"],
        },
        {
          type: "category",
          label: "Dependencies",
          items: [
            {
              type: "doc",
              id: "user-guide/dependencies/endpoints",
              label: "Endpoints",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              type: "doc",
              id: "user-guide/authorization/custom-roles",
    ...
    },
    {
      type: "category",
      label: "Tutorials",
      items: ["use-cases/deploy-prebuilt-image"],
    },
    {
      type: "category",
