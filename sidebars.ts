          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {type: 'doc', id: 'reference/api/platform/authzclusterrole', label: 'ClusterAuthzRole'},
                {type: 'doc', id: 'reference/api/platform/authzrole', label: 'AuthzRole'},
                {type: 'doc', id: 'reference/api/platform/authzclusterrolebinding', label: 'ClusterAuthzRoleBinding'},
