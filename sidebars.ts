          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {type: 'doc', id: 'reference/api/platform/clusterauthzrole', label: 'ClusterAuthzRole'},
                {type: 'doc', id: 'reference/api/platform/authzrole', label: 'AuthzRole'},
                {type: 'doc', id: 'reference/api/platform/clusterauthzrolebinding', label: 'ClusterAuthzRoleBinding'},
