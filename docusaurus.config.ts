...
const config: Config = {
  ...
  themeConfig: {
    announcementBar: {
      id: 'release_v0_8_0',
      content:
        '🎉️ OpenChoreo <a target="_blank" rel="noopener noreferrer" href="https://github.com/openchoreo/openchoreo/releases/tag/v0.8.0">v0.8.0</a> has been released! Explore what’s new. 🎉',
      isCloseable: true,
    },
    algolia: {
      appId: 'B8ST9KVWVJ',
