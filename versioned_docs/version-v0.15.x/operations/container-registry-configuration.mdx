...
|-----------|-------------|----------|
| `defaultResources.registry.host` | Registry hostname | Yes |
| `defaultResources.registry.repoPath` | Path prefix for images | No |
| `defaultResources.registry.tlsVerify` | Verify TLS certificates | No (default: `false`) |
...
{`helm upgrade --install openchoreo-build-plane oci://ghcr.io/openchoreo/helm-charts/openchoreo-build-plane \\
  ...
  --reuse-values \\
  --set defaultResources.registry.host=123456789.dkr.ecr.us-east-1.amazonaws.com \\
...
{`helm upgrade --install openchoreo-build-plane oci://ghcr.io/openchoreo/helm-charts/openchoreo-build-plane \\
  ...
  --namespace openchoreo-build-plane \\
  --reuse-values \\
  --set defaultResources.registry.host=us-central1-docker.pkg.dev/my-project/openchoreo-builds \\
  --set defaultResources.registry.tlsVerify=true`}
</CodeBlock>
...
{`helm upgrade --install openchoreo-build-plane oci://ghcr.io/openchoreo/helm-charts/openchoreo-build-plane \\
  ...
  --namespace openchoreo-build-plane \\
  --reuse-values \\
  --set defaultResources.registry.host=myregistry.azurecr.io \\
  --set defaultResources.registry.tlsVerify=true`}
</CodeBlock>
...
{`helm upgrade --install openchoreo-build-plane oci://ghcr.io/openchoreo/helm-charts/openchoreo-build-plane \\
  ...
  --namespace openchoreo-build-plane \\
  --reuse-values \\
  --set defaultResources.registry.host=ghcr.io \\
  --set defaultResources.registry.repoPath=my-org/openchoreo \\
  --set defaultResources.registry.tlsVerify=true`}
</CodeBlock>
...
{`helm upgrade --install openchoreo-build-plane oci://ghcr.io/openchoreo/helm-charts/openchoreo-build-plane \\
  ...
  --namespace openchoreo-build-plane \\
  --reuse-values \\
  --set defaultResources.registry.host=docker.io \\
  --set defaultResources.registry.repoPath=your-username \\
  --set defaultResources.registry.tlsVerify=true`}
</CodeBlock>
