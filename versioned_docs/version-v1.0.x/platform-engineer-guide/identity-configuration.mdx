...
OpenChoreo ships with **ThunderID** as the default identity provider. ThunderID is a lightweight, OAuth2/OIDC compliant identity management platform that enables quick setup for development and testing environments.
