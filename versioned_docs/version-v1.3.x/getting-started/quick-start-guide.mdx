...
<div className="step-card">
    ...
    The installer also prints the users for the other default roles, and the ThunderID console `admin` password. See [Default Credentials](./try-it-out/on-your-environment.mdx#default-credentials) for the full list.
...
<div className="content-section-highlight">
    ...
    The Backstage UI is powered by the OpenChoreo Backstage plugin, providing a unified interface for managing your components and deployments. The authentication and user management is handled by ThunderID, a lightweight identity management platform that secures access to your OpenChoreo environment.
