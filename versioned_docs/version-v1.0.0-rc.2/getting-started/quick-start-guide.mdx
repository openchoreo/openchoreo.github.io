...
<div className="content-section-highlight">
    ...
    The Backstage UI is powered by the OpenChoreo Backstage plugin, providing a unified interface for managing your components and deployments. The authentication and user management is handled by Asgardeo, a lightweight identity management platform that secures access to your OpenChoreo environment.
