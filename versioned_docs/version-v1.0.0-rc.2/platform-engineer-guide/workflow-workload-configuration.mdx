---
title: Workflow Workload Configuration
description: Configure CI workflow authentication and authorization for workload publishing.
sidebar_position: 10
---
...
- [Workload Generation](../developer-guide/workflows/ci/workload-generation.md) — How CI workflows create Workload CRs
