...
:::info
See [Identity Configuration](../../../platform-engineer-guide/identity-configuration.mdx) for Thunder access details and default credentials.
:::
...
The request body specifies containers, endpoints, and dependencies for the component. For the full schema and examples, see the [Workload API Reference](../../../reference/api/application/workload.md).
