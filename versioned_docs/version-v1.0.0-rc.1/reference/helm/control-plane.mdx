...
| `controllerManager.dataplaneNetworkPolicies.enabled` | Enable NetworkPolicy enforcement for endpoint visibility on the data plane | `boolean` | `true` |
...
| `openchoreoApi.config.legacy_mcp.enabled` | Enable the MCP server for AI-friendly tool interfaces | `boolean` | `true` |
| `openchoreoApi.config.legacy_mcp.toolsets` | List of enabled MCP legacy toolsets. Each toolset exposes a group of related operations. | `array` | `["namespace","project","component","deployment","infrastructure","schema","resource"]` |
...
| `openchoreoApi.config.mcp.toolsets` | List of enabled MCP toolsets. Each toolset exposes a group of related operations. Allowed toolsets: namespace, project, component, infrastructure, pe | `array` | `["namespace","project","component","infrastructure"]` |
