...
It collects and aggregates logs from the Control, Data, and CI planes using a distributed log collection pattern provided by collection agents configured via the observability modules.
