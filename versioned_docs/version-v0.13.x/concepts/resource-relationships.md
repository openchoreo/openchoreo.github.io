...
OpenChoreo also supports cluster-scoped resources that exist at the cluster level and can be referenced across namespaces, providing shared platform capabilities. This hybrid model enables both namespace-level isolation for team-specific resources and cluster-wide sharing of common platform infrastructure.
