...
Learn more about policies in the [WSO2 API Platform](https://github.com/wso2/api-platform/tree/gateway-v0.1.0/gateway/policies).
:::
...
policies: [ { "name": "JwtAuthentication", "version": "v0.1.0" } ]
upstreamPort: 80
```
:::
