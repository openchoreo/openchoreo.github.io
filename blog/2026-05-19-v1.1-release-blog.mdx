...
authors: [binura]
description: "Read about the new features, improvements, and AI capabilities in OpenChoreo v1.1, our latest release since joining the CNCF Sandbox."
category: announcements
pinned: true
image: ./assets/v1.1-release-blog/preview.png
---
...
We’re thrilled to announce the [OpenChoreo](https://openchoreo.dev/?utm_source=mp&utm_medium=link&utm_campaign=blog_link_global_openchoreo_v1.1releaseblog_051926) v1.1 release. This marks our first minor release since the v1.0 GA announcement and the project’s acceptance into the CNCF Sandbox in March 2026.
...
[OpenChoreo](https://openchoreo.dev/?utm_source=mp&utm_medium=link&utm_campaign=blog_link_global_openchoreo_v1.1releaseblog_051926) now natively integrates with [Cilium](https://cilium.io/), a CNCF project that provides eBPF-based networking, observability, and security in data planes.
...
[Install the Cilium module from the ecosystem →](https://openchoreo.dev/ecosystem/networking-cilium) 
...
This agent is based on the existing [Prometheus metrics module](https://openchoreo.dev/ecosystem/metrics-prometheus) and [OpenCost](https://opencost.io/), an open-source project for real-time cloud infrastructure and container cost measurement.
...
[Install the FinOps agent from the ecosystem →](https://openchoreo.dev/ecosystem/finops-opencost)
...
[Install the agentgateway module from the ecosystem →](https://openchoreo.dev/ecosystem/agentgateway)
...
[Set up agent sandboxing from the ecosystem →](https://openchoreo.dev/ecosystem/agent-sandbox)
...
* [Get started](https://openchoreo.dev/docs/getting-started/quick-start-guide/?utm_source=mp&utm_medium=link&utm_campaign=blog_link_global_openchoreo_v1.1releaseblog_051926)  
