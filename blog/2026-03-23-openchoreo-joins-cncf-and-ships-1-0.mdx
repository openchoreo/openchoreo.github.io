...
image: ./assets/joining-cncf-blog/preview.png
---

We're very excited to announce that [OpenChoreo](https://openchoreo.dev/?utm_source=mp&utm_medium=link&utm_campaign=blog_link_global_openchoreo_joinscncf_032326) has been accepted into the Cloud Native Computing Foundation ([CNCF](https://www.cncf.io/)) Sandbox.
...
- [Get started](https://openchoreo.dev/docs/getting-started/quick-start-guide/?utm_source=mp&utm_medium=link&utm_campaign=blog_link_global_openchoreo_joinscncf_032326)
