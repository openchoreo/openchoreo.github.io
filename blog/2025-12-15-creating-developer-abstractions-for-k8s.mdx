...
description: ""
category: technology
image: ./assets/creating-developer-abstractions/01-k8s-app.png
---
...
[OpenChoreo](https://openchoreo.dev/?utm_source=mp&utm_medium=link&utm_campaign=blog_link_global_openchoreo_developerabstractions_121525) enables platform teams to build declarative, strongly-typed, developer-friendly abstractions that **only augment Kubernetes rather than obscure it**. 
