...
We're pleased to announce the release of OpenChoreo v1.3. This release brings a number of exciting higher-level capabilities that work across the platform, built by composing our existing developer and platform APIs.

Key highlights include cost insights, DORA metrics powered by a new delivery insights module, a faster local development experience, platform logs for OpenChoreo system components, and a new module for emitting and collecting audit logs across the platform.
...
### Delivery and stability insights dashboard and MCPs with DORA metrics (alpha)
