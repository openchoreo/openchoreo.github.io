...
With OpenChoreo, we are bringing the best ideas of [WSO2 Developer Platform](https://choreo.dev) (an IDP as a Service) to the open-source community. WSO2 Developer Platform is designed not just to automate software delivery workflows, but to support engineering best practices: enforcing architecture standards, promoting service reuse, and integrating API management and observability.
