...
slug: /
description: OpenChoreo is an open-source IDP that transforms Kubernetes into a self-service platform with CI/CD, API management, and built-in observability.
---
