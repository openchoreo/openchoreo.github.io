...
7. **[Working with AI](../ai/overview.mdx)** - Learn how to use your AI assistants (like Claude Code, Codex, etc) with OpenChoreo and set up the built-in platform agents
