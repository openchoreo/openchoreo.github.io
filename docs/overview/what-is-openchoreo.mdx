...
import PlanesOverviewImg from "../resources/what-are-planes-overview.svg";
...
It uses a unified API surface and a modular architecture to deliver a wholistic platform experience that is greater than what any combination of tools could offer on its own.

<ExpandableImage
  src={PlanesOverviewImg}
  alt="What are OpenChoreo planes"
/>

This multi-plane architecture not only provides flexible deployment topologies that can span multiple clusters and cloud providers, but also allows platform teams to scale and evolve their platform at their own pace, without having to re-architect the entire platform as requirements change; which is an inevitable part of building an internal developer platform-as-a-product.
...
Many organizations are investing in internal developer platforms to improve developer velocity & reduce cognitive load, enforce organization-wide standards, and reduce overall operational complexity. However, designing, building and maintaining a production-grade platform is a difficult task.
...
OpenChoreo was originally developed by [WSO2](https://wso2.com), as the successor and next evolution of its SaaS *WSO2 Developer Platform* (formerly known as *WSO2 Choreo*), bringing years of battle-hardened platform engineering experience and lessons learnt, to the CNCF open source community.
