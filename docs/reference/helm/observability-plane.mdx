...
| Parameter | Description | Type | Default |
| :--- | :--- | :--- | :--- |
| `fakeSecretStore.enabled` | Enable fake secret store (requires External Secrets Operator to be installed) | `boolean` | `false` |
...
| `observer.ingress.hosts` | Ingress hosts | `array` |  |
...
| `rca.ingress.hosts` | Ingress hosts | `array` |  |
