...
| :--- | :--- | :--- | :--- |
| [traefik](https://traefik.github.io/charts) | 34.4.1 | [https://traefik.github.io/charts](https://traefik.github.io/charts) | `traefik.enabled` |
| [thunder](oci://ghcr.io/asgardeo/helm-charts) | 0.15.0 | oci://ghcr.io/asgardeo/helm-charts | `thunder.enabled` |
...
| `backstage.auth.authorizationUrl` | OAuth authorization endpoint URL. If empty, auto-derived from Thunder | `string` |  |
...
| `backstage.auth.tokenUrl` | OAuth token endpoint URL. If empty, auto-derived from Thunder | `string` |  |
...
For full configuration options, please refer to the [official chart documentation](oci://ghcr.io/asgardeo/helm-charts).
...
For full configuration options, please refer to the [official chart documentation](https://traefik.github.io/charts).
