...
- **Public registries** (e.g., Docker Hub, GitHub Container Registry public images) - No additional configuration needed
...
To pull images from a private registry, you need to:
