...
```bash
curl http://default.development.openchoreoapis.localhost:19080/greeter-service/greeter/greet\?name\=OpenChoreo
```
...
```bash
curl -i http://default.development.openchoreoapis.localhost:19080/greeter-service/greeter/greet
```
...
Your components are now protected with OAuth2 security—all managed declaratively through OpenChoreo!

## Next Steps

- [Learn more about WSO2 API Platform policies](https://github.com/wso2/api-platform/tree/gateway-v0.1.0/gateway/policies)
