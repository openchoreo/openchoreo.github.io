...
The bulk promote workflow requires that ComponentReleases already exist in your GitOps repository. Components must be built first using [build and release workflows](./build-and-release-workflows.md) before they can be promoted.
:::
...
**Solution**:
- Ensure components have been built using [build and release workflows](./build-and-release-workflows.md)
...
- [Build and Release Workflows](./build-and-release-workflows.md) — Component-level GitOps workflows
