...
:::note
The subject types shown in the wizard are dynamic and reflect what is configured in your installation. You can customize the available types, display names, and claim mappings through the Helm values — see [Subject Types](../../operations/authorization.md#subject-types).
:::
...
Add one or more role-scope pairs. Each role mapping combines a role (defining *what* actions are permitted) with a scope (defining *where* those actions apply).
...
{/* TODO: Replace with updated screenshot of the Effect step */}
<img
...
{/* TODO: Replace with updated screenshot of the Review step */}
<img
