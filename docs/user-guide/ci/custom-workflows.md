...
3. **Allow ComponentWorkflow** in the ComponentType (enables developers to use the workflow)
...
```
:::note
If you follow this approach, make sure the output parameter name is `workload-cr` and the step name is `generate-workload-cr`.
:::
