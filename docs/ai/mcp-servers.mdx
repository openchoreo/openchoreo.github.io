...
Client credentials clients require a role binding to authorize access to OpenChoreo resources. See the [Custom Roles and Bindings](../developer-guide/authorization/custom-roles.mdx) guide for details on creating roles and role bindings via the UI.
:::
