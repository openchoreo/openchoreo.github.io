...
OpenChoreo supports cluster-scoped variants of plane resources that are available across all namespaces:

- **ClusterDataPlane** - A cluster-scoped DataPlane available to Environments in any namespace. See the [ClusterDataPlane API Reference](../reference/api/platform/clusterdataplane.md).
- **ClusterBuildPlane** - A cluster-scoped BuildPlane available to Projects in any namespace. See the [ClusterBuildPlane API Reference](../reference/api/platform/clusterbuildplane.md).
- **ClusterObservabilityPlane** - A cluster-scoped ObservabilityPlane that can be referenced by any DataPlane, ClusterDataPlane, BuildPlane, or ClusterBuildPlane. See the [ClusterObservabilityPlane API Reference](../reference/api/platform/clusterobservabilityplane.md).
