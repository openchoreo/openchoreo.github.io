...
kubectl get workflows.openchoreo.dev ballerina-buildpack -o yaml | yq eval ".metadata.namespace = \\"$NAMESPACE_NAME\\"" - | kubectl apply -f -
kubectl get workflows.openchoreo.dev docker -o yaml | yq eval ".metadata.namespace = \\"$NAMESPACE_NAME\\"" - | kubectl apply -f -
kubectl get workflows.openchoreo.dev google-cloud-buildpacks -o yaml | yq eval ".metadata.namespace = \\"$NAMESPACE_NAME\\"" - | kubectl apply -f -
kubectl get workflows.openchoreo.dev react -o yaml | yq eval ".metadata.namespace = \\"$NAMESPACE_NAME\\"" - | kubectl apply -f -`}
</CodeBlock>

**Verification:**

<CodeBlock language="bash">
{`kubectl get workflows.openchoreo.dev -n $NAMESPACE_NAME`}
</CodeBlock>
...
<CodeBlock language="bash">
{`kubectl get componenttype,workflows.openchoreo.dev -A | grep $NAMESPACE_NAME`}
</CodeBlock>
