...
If you followed the [local setup guide](../getting-started/try-it-out/on-k3d-locally.mdx#step-7-setup-observability-plane-optional), run:
...
kubectl create secret generic rca-sql-backend \
  --namespace openchoreo-observability-plane \
  --from-literal=uri="postgresql+asyncpg://user:password@host:5432/dbname"
```
