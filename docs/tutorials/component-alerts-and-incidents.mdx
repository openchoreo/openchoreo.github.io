...
If you have properly configured the [RCA Agent](../ai/rca-agent.mdx), you can verify AI root cause analysis by checking the RCA reports in the Backstage portal when an incident is created.
...
- Configure and tune the [RCA Agent](../ai/rca-agent.mdx) for your observability/AI requirements.
