...
<div className="step-card">
    ...
    🌍 Access the application at: http://default.react-starter-development.openchoreoapis.localhost:19080
...
<div className="content-section-highlight">
    ...
    - [Deployment Pipeline](/docs/reference/api/platform/deployment-pipeline)
    - Project
