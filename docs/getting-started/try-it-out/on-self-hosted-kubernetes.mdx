...
<details>
<summary>Don't have cert-manager or External Secrets Operator? Install them here</summary>
...
- `gateway.publicVirtualHost`: where your deployed applications become accessible. When you deploy a component later, it'll be reachable at something like `http://default.dev.openchoreoapis.localhost:19080/your-component/`.
...
| Deployed Apps | `http://<component namespace>.<env>.openchoreoapis.localhost:19080/<component>/...` |
