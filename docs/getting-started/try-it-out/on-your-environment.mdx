...
:::note[TTL.sh]
Images on ttl.sh expire after 24 hours. For production, use your cloud provider's registry (ECR, GAR, ACR). See [Container Registry Configuration](../../operations/container-registry-configuration.mdx).
:::
...
- **Install the traces module** (`observability-traces-opensearch`) for distributed tracing on OpenSearch.
