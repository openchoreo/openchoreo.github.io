...
- Port mappings for all planes (8080, 19080, 10081)
...
<TabItem value="k3s" label="k3s (Linux)">

[k3s](https://k3s.io) is a lightweight Kubernetes distribution for Linux.
...
:::note macOS Users
If you're on macOS with Rancher Desktop (Rosetta) or Docker Desktop, add this flag to fix Envoy temporary file issues:
```
...
| Deployed Apps | `http://<component>-<env>.openchoreoapis.localhost:19080` |
