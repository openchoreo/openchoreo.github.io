...
- **ClusterTraits**: api-configuration, observability-alert-rule
...
<VersionedCodeBlock script={(docsPrefix) =>
  `curl -fsSL https://openchoreo.dev${docsPrefix}/getting-started/try-it-out/on-k3d-locally/k3d-observability-plane.sh | bash`
} />

If you later want to enable Fluent Bit log collection, follow the **Link Planes and Enable Logs** section below.
