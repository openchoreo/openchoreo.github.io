...
<VersionedCodeBlock script={(docsPrefix) =>
  `curl -fsSL https://openchoreo.dev${docsPrefix}/getting-started/try-it-out/on-k3d-locally/k3d-observability-plane.sh | bash -s -- "${versions.helmChart}" "${versions.githubRef}"`
} />
