...
<CodeBlock language="bash">
  {`curl -fsSL https://raw.githubusercontent.com/openchoreo/openchoreo/${versions.githubRef}/install/k3d/k3d-observability-plane.sh | bash -s -- "${versions.helmChart}" "${versions.githubRef}"`}
</CodeBlock>
