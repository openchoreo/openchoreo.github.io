...
- **OpenChoreo context** set to your cluster (should be `k3d-openchoreo` if following the k3d setup)

## Step 1: Verify Your Setup

First, make sure you have setup OpenChoreo on your cluster following the [installation guide](./single-cluster.mdx).
