...
- **OpenChoreo installed** in your Kubernetes cluster (see [Run Locally](./try-it-out/on-k3d-locally.mdx) or the [Platform Engineer Guide](../platform-engineer-guide/deployment-topology.mdx) for production setup)
